...
1. Import the data file 'Mites.txt' into R. We want to model the variable Toxic as a categorical predictor with 4 levels, so create a new variable with Toxic as a factor.

\  

```{r Q1, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE}
Mites<- read.delim("./data/DrugsMites.txt", stringsAsFactors = TRUE)
str(Mites)
