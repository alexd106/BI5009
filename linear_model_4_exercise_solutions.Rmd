...
12\. Last write-up, and the least help of the lot. You arrived at your final model by a selection procedure, which brings a couple of reporting problems that the previous three exercises didn't have.

Write **no more than 200 words** describing this analysis for the methods and results of a paper. Your reader is an ecologist who knows their stuff but isn't a statistician, and who wasn't in the room while you did the analysis. They need to be able to work out from your text exactly what you did and how much to trust it. Questions 4 and 11 have already told you the two things an honest account has to include that a naive one would leave out.
