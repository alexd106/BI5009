...
5. Fit an appropriate linear model in R to explain the variation in the response variable, `ABUND` with the explanatory variable `FGRAZE`. Remember to use the `data =` argument. Assign this linear model to an appropriately named object (`birds.lm` if you imagination fails you!).
