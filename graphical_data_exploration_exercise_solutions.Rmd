...
## Exercise: Graphical data exploration

\  

1\.  Start RStudio on your computer and reopen the RStudio Project you created in Exercise 1 (select File --> Open Project on the main menu, or use the Project drop-down at the top right of the RStudio window). You will use this same Project for the rest of the course, so there is no need to create a new one. If you need a reminder about RStudio Projects see [Section 1.6](https://intro2r.com/rsprojs.html#rsprojs) of the Introduction to R book and [here](https://alexd106.github.io/EV5020/howto.html#rstudio_proj-vid) for a short video.

Now create a new R script inside this Project by selecting File –> New File –> R Script from the main menu (or use the shortcut button). Before you start writing any code save this script by selecting File –> Save from the main menu. Call this script ‘graphical_data_exploration’ or something similar. Click on the ‘Files’ tab in the bottom right RStudio pane to see whether your file has been saved in the correct location. Ok, at the top of almost every R script (there are very few exceptions to this!) you should include some metadata to help your collaborators (and the future you) know who wrote the script, when it was written and what the script does (amongst other things). Include this information at the top of your R script making sure that you place a # at the beginning of every line to let R know this is a comment. See [Section 1.10](https://intro2r.com/proj_doc.html) for a little more detail.
...
End of Graphical data exploration Exercise
