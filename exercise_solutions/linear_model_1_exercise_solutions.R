...
# they stick out a bit to the right comapred to the rest of the residuals. 
...
# new LOGAREA values in the data frame MyData (use the newdata argument)
...
# dataframe, the precited values are from pred.vals 
...
# the model doesn't look too great now! Technically, if we tranform variables in our model
...
# data very well, especially for the two large forest patch AREAs and also thos patches with
# high bird abundance.
