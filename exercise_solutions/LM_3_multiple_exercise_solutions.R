## ---- eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE---------------------------------------------
...
## ---- eval=SOLUTIONS, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE----------------------------------------
...
## ---- eval=TRUE, echo=TRUE, collapse=FALSE--------------------------------------------------------------------
par(mfrow= c(1, 1))
...
## ---- eval=SOLUTIONS, echo=SOLUTIONS, results=SOLUTIONS, collapse=FALSE---------------------------------------
## par(mfrow= c(1, 1))
## plot(ABUND ~ LOGAREA, data= loyn, col= GRAZE, pch= 16)
## 
## # let's use a loop, to save repeating the following sequence 5 times:
...
## ---- eval=TRUE, echo=TRUE, collapse=TRUE---------------------------------------------------------------------
