...
# now produce the plots - the response variable first,
# then each of the continuous explanatory variables
...
# Also one potentially large distance in DIST, and LDIST is skewed in the
# same way (it ranges from 26 to 4426)
# One option would be to log10 transform AREA, DIST and LDIST
...
# first split the plotting device into 1 row
# and 3 columns
par(mfrow = c(1,3))
