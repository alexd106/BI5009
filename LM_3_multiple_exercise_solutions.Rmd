...
```{r, eval=TRUE, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE}
...
```{r, eval=SOLUTIONS, echo=SOLUTIONS, results=SOLUTIONS, collapse=TRUE}
...
```{r, eval=TRUE, echo=TRUE, collapse=FALSE}
par(mfrow= c(1, 1))
...
```{r, eval=SOLUTIONS, echo=SOLUTIONS, results=SOLUTIONS, collapse=FALSE}
par(mfrow= c(1, 1))
plot(ABUND ~ LOGAREA, data= loyn, col= GRAZE, pch= 16)
