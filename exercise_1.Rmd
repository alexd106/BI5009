...
13.	R's working directory is the default location of any files you read into R, or save out of R. Although you won't be reading in or exporting files just yet (that's a job for future exercises) it is useful to be able to determine what your current working directory is. So, figure out how to display your current working directory (try Google or read [Section 1.7](https://intro2r.com/work-d.html) of the R book).
