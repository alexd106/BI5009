...
3. Next, use R to determine the area of a circle with a diameter of 20 cm and assign the result to a variable called `area_circle`. Google is your friend if you can't remember the formula! Also, remember that R already knows about `pi`. Don't worry if you're stumped feel free to ask one of the instructors for guidance.
