...
2. Let's use R as a fancy calculator. Find the natural log, log10, log2, square root and the natural antilog of 12.43. Don't forget to write your code in RStudio's script editor and source the code into the console. see [Section 2.1](https://intro2r.com/getting-started.html) of the R book to get you started.
...
10.	Next, see if you can figure out how to create a sequence from 10 to 1 in steps of 0.5. Assign to a variable called `seq2` (Hint: you may find it easier to include the `rev()` function in your code).
