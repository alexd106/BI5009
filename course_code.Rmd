...
```{r sol-GDE, results='asis', , eval = isTRUE(show_text_GDE)}
paste0("- [Graphical data exploration exercise solutions](exercise_solutions/graphical_data_exploration_exercise_solutions.R)")
```
