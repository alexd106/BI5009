...
```{r ex15, results='asis', eval = isTRUE(show_exercise)}
...
rmarkdown::render("GLM_2_Binomial_exercise.Rmd", output_format = "pdf_document", output_file = "./exercises/GLM_2_Binomial_exercise.pdf", quiet = TRUE)
```
...
\  
 ...
 - [Generalised linear models 1 - Poisson GLM exercise](GLM_1_Poisson_exercise_solutions.html)

 - [Generalised linear models 2 - Binomial GLM exercise](GLM_2_Binomial_exercise_solutions.html)
