...
10\. And again, but with less help this time. Write up this analysis as a single paragraph for your thesis, referring to your figure from Question 9. No ingredient list, you decide what goes in.

Three things I'd like you to get right, because they're the three that people most often get wrong when reporting an interaction:

- You have a clear interaction. Is "bird abundance increases with patch area" a sentence you can write on its own here?
- `FGRAZE2` and `FGRAZE2:LOGAREA` both had confidence intervals that included zero. Report them without claiming that the two grazing levels are the same.
- Your model has 10 parameters. Does a reader need all 10 of them?
